var monthlydatatreiness= document.querySelector("#chart1").getAttribute('role');
// const str = "1, 67, 190, 121, 23, 22, 12, 8, 17, 26, 6, 0";

// Step 1: Convert the string to an array of numbers
const originalDatasignups = monthlydatatreiness.split(',').map(item => parseInt(item.trim(), 10));

// Step 2: Apply a transformation, e.g., adding 75 to each number (you can adjust the logic as needed)
const signups = originalDatasignups.map(item => item );
