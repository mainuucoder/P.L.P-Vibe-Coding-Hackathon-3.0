...
// chart 2
    ...
    var options = {
      ...
      colors: ["#8f50ff", "#f1076f", "#ffd200", "#cddc35"],
            series: [90, 80, 70, 60],
            labels: ['ICT', 'Finance', 'Human Resource', 'Legal'],
			responsive: [{
                breakpoint: 1280,
                options: {
                    chart: {
...
var options = {
        ...
        dropShadow: {
            ...
            xaxis: {
                categories: ['Finacial', 'Legal', 'Human Resource', 'ICT', 'Procurement', 'Audit', 'Communication', 'Customer Relation', 'Record management', 'Security'],
            },
            yaxis: {
                labels: {
                    show: false
  ...
  // chart 6
    ...
    var options = {
           ...
           toolbar: {
            ...
            title: {
                text: 'Audit Compliance Reports, 2024',
                floating: true,
                offsetY: 0,
                align: 'center',
                style: {
...
var options = {
          ...
          sparkline:{
            ...
            series: [{
                name: 'Non-Compliance rates',
                data: [15, 26, 20, 33, 27, 43, 17, 26, 19]
            },{
                name: 'Compliace rates',
