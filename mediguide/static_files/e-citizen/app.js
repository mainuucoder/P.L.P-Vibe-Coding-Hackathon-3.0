...
exports.default = {
  ...
  methods: {
    ...
    initialize_dashboard_data: function initialize_dashboard_data() {
      var _this2 = this;
      ...
      Vue.axios.post(api_url, payload).then(function (response) {
        var content = response.data.content;
        _this2.merchants = content.merchants;
        _this2.default_currency = content.currency;
        _this2.dt_revenue_today = content.revenue_today;
        _this2.dt_revenue_this_month = content.revenue_this_month;
        _this2.dt_revenue_this_year = content.revenue_this_year;
        _this2.dt_revenue_all_time = content.revenue_all_time;
        _this2.daily_reg = content.daily_reg;
        _this2.monthly_reg = content.monthly_reg;
        _this2.annual_reg = content.annual_reg;
        _this2.all_time_reg = content.all_time_reg;
        _this2.hourly_revenue = content.hourly_revenue;
        _this2.daily_revenue = content.daily_revenue;
        _this2.monthly_revenue = content.monthly_revenue;
        _this2.annual_revenue = content.annual_revenue;
        _this2.revenue_last_7days = content.revenue_last_7days;
        _this2.revenue_last_14days = content.revenue_last_14days;
        _this2.revenue_last_30days = content.revenue_last_30days;
        _this2.board_data = content.service_leader_board;
        _this2.applications_per_gateway_data = content.gateway_sales;
        _this2.applications_per_gateway_encoded_data = content.encoded_gateway_sales;

        _this2.weekly_applications_customers = content.weekly_applications_customers;
        _this2.monthly_applications_customers = content.monthly_applications_customers;
        _this2.bi_weekly_applications_customers = content.bi_weekly_applications_customers;
        _this2.years = content.years;

        _this2.emitToBoard();
        _this2.set_dashboard_data();
    ...
    fetch_dashboard_data: function fetch_dashboard_data(accounts) {
      var _this3 = this;
      ...
      Vue.axios.post(api_url, payload).then(function (response) {
        var content = response.data.content;
        _this3.merchants = content.merchants;
        _this3.default_currency = content.currency;
        _this3.dt_revenue_today = content.revenue_today;
        _this3.dt_revenue_this_month = content.revenue_this_month;
        _this3.dt_revenue_this_year = content.revenue_this_year;
        _this3.dt_revenue_all_time = content.revenue_all_time;
        _this3.daily_reg = content.daily_reg;
        _this3.monthly_reg = content.monthly_reg;
        _this3.annual_reg = content.annual_reg;
        _this3.all_time_reg = content.all_time_reg;
        _this3.hourly_revenue = content.hourly_revenue;
        _this3.daily_revenue = content.daily_revenue;
        _this3.monthly_revenue = content.monthly_revenue;
        _this3.annual_revenue = content.annual_revenue;
        _this3.revenue_last_7days = content.revenue_last_7days;
        _this3.revenue_last_14days = content.revenue_last_14days;
        _this3.revenue_last_30days = content.revenue_last_30days;
        _this3.board_data = content.service_leader_board;
        _this3.applications_per_gateway_data = content.gateway_sales;
        _this3.applications_per_gateway_encoded_data = content.encoded_gateway_sales;

        _this3.weekly_applications_customers = content.weekly_applications_customers;
        _this3.monthly_applications_customers = content.monthly_applications_customers;
        _this3.bi_weekly_applications_customers = content.bi_weekly_applications_customers;
        _this3.years = content.years;

        _this3.emitToBoard();
        _this3.set_dashboard_data();
